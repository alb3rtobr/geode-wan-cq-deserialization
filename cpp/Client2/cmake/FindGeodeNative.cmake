...
set(_GeodeNative_CRYPTO_NAMES cryptoImpl)

set(_CMAKE_FIND_LIBRARY_SUFFIXES ${CMAKE_FIND_LIBRARY_SUFFIXES})
set(CMAKE_FIND_LIBRARY_SUFFIXES ${CMAKE_SHARED_LIBRARY_SUFFIX})
find_library(GeodeNative_CRYPTO_LIBRARY
    NAMES ${_GeodeNative_CRYPTO_NAMES}
    HINTS ${_GeodeNative_HINTS}
    PATHS ${_GeodeNative_PATHS}
    PATH_SUFFIXES apache-geode/lib lib apache-geode/bin bin
)
...
if (GeodeNative_FIND_COMPONENTS)
  ...
  foreach (component ${GeodeNative_FIND_COMPONENTS})
    ...
    if (component STREQUAL "crypto")
      list(APPEND _GeodeNative_REQUIRED_VARS GeodeNative_CRYPTO_LIBRARY)
    endif()
...
if(GeodeNative_FOUND)
  ...
  set(GeodeNative_CRYPTO_TARGET "GeodeNative::crypto")
  if(NOT TARGET ${GeodeNative_CRYPTO_TARGET})
    add_library(${GeodeNative_CRYPTO_TARGET} UNKNOWN IMPORTED)
    set_target_properties(${GeodeNative_CRYPTO_TARGET} PROPERTIES
      IMPORTED_LINK_INTERFACE_LANGUAGES "CXX"
      IMPORTED_LOCATION "${GeodeNative_CRYPTO_LIBRARY}")
  endif()
