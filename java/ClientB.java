...
public class ClientB {
  ...
  public static final String CLIENT_NAME = "clientB";
  ...
  public static void main(String[] args) {
    ...
    poolFactory.addLocator("localhost", 10332);
    ...
    clientRegionFactory.addCacheListener(new ExampleCacheListener(ClientB.CLIENT_NAME));
